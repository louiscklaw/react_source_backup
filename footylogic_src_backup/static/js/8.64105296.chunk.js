(this.webpackJsonphkjc_fe = this.webpackJsonphkjc_fe || []).push([
  [8],
  {
        ...
        if (!n) {
          ...
          return (
            ...
            (P = a({}, P, {
              touchObject: w,
              swipeLeft: E,
              trackStyle: O(a({}, t, { left: E })),
            })),
            Math.abs(w.curX - w.startX) < 0.8 * Math.abs(w.curY - w.startY)
              ? P
              : (w.swipeLength > 10 && ((P.swiping = !0), e.preventDefault()),
                P)
          );
        }
      };
            ...
            (Array.from(r).every(function (r) {
              if (e.vertical) {
                if (r.offsetTop + v(r) / 2 > -1 * e.swipeLeft)
                  return (n = r), !1;
              } else if (r.offsetLeft - t + h(r) / 2 > -1 * e.swipeLeft)
                return (n = r), !1;
              return !0;
            }),
            !n)
    ...
    476: function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      var i = ((r = n(477)) && r.__esModule ? r : { default: r }).default;
      t.default = i;
    },
    477: function (e, t, n) {
      "use strict";
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (e = this.state.breakpoint
                    ...
                    : f({}, s.default, {}, this.props)).centerMode &&
    ...
    480: function (e, t, n) {
      (function (t) {
        ...
        e.exports = function (e, t, n) {
          ...
          function m(e) {
            return (c = e), (a = setTimeout(S, t)), u ? g(e) : s;
          }
          function w(e) {
            var n = e - l;
          ...
          function O(e) {
            return (a = void 0), b && r ? g(e) : ((r = i = void 0), s);
          }
          function k() {
            var e = p(),
              n = w(e);
            if (((r = arguments), (i = this), (l = e), n)) {
              ...
              if (y) return (a = setTimeout(S, t)), g(l);
            }
              ...
              if (
                (n.push(
                  r.default.cloneElement(p, {
                    ...
                    style: v({ outline: "none" }, p.props.style || {}, {}, y),
                    onClick: function (t) {
          ...
          function h(e) {
            ...
            if (
              ("border-box" === r.boxSizing &&
                ...
                Math.round(l + s) !== n && (l -= p(r, "top", "bottom") + s)),
              !(function (e) {
...
//# sourceMappingURL=8.64105296.chunk.js.map
