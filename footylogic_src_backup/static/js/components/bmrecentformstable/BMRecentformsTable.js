...
import {
  ...
  bindLineValues,
  filterChanged,
} from "./BMRecentformsTableSlice";
import { metaData } from "../../AppSlice";

class BMRecentformsTable extends Component {
  constructor() {
    super();
    this.state = {
                    ...
                    this.props.mainColumns.map((column, columnIndex) => {
                      return (
                        <React.Fragment>
                          <th colspan="2">
                            ...
                            <div className="form-group mt-10">
                              <div className="form-control">
                                <span>
                                  {this.props.staticKeyWords.goalLine}
                                </span>{" "}
                                <select
                                  onChange={(event) =>
                                    this.props.dispatch(
                          ...
                          {column.rowspan && <th class="w-30" rowspan="1"></th>}
                        </React.Fragment>
                      );
                    })}
                </tr>
                  ...
                  Object.keys(this.props.data).map((key, keyIndex) => {
                    return (
                      <tr key={keyIndex}>
                        ...
                        {(this.props.isHilo || this.props.isCornersHilo
                            ...
                            if (this.props.isHilo) {
                              return (
                                <React.Fragment key={rowIndex}>
                                  ...
                                  {Object.keys(this.props.data[key]).length -
                                    1 !=
                                    rowIndex && (
                                    <td>
                                      <div></div>
...
function mapStateToProps(state) {
  return {
    ...
    hiloFilters: state.bmstatistics.hiloFilters,
    seledtedFilter: state.bmstatistics.seledtedFilter,
    cornersFilters: state.bmstatistics.cornersFilters,
...
export default connect(mapStateToProps, mapDispatchToProps)(BMRecentformsTable);
