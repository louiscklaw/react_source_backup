...
exports.Popover = react_1.forwardRef(function (_a, externalRef) {
  var isOpen = _a.isOpen,
    ...
    _f = _a.containerParent,
    containerParent = _f === void 0 ? window.document.body : _f,
    _g = _a.containerClassName,
    containerClassName = _g === void 0 ? 'react-tiny-popover-container' : _g,
    containerStyle = _a.containerStyle,
    contentLocation = _a.contentLocation,
    _h = _a.boundaryInset,
    boundaryInset = _h === void 0 ? 0 : _h,
    ...
    function () {
      if (!isOpen)
        setPopoverState(function (prev) {
          return __assign(__assign({}, prev), { isPositioned: false });
        });
    },
    [isOpen],
  );
  ...
  var handleOnClickOutside = react_1.useCallback(
    function (e) {
      var _a, _b;
      if (
        isOpen &&
        !((_a = popoverRef === null || popoverRef === void 0 ? void 0 : popoverRef.current) === null || _a === void 0
          ? void 0
          : _a.contains(e.target)) &&
        !((_b = childRef === null || childRef === void 0 ? void 0 : childRef.current) === null || _b === void 0
          ? void 0
  ...
  var handleWindowResize = react_1.useCallback(
    function () {
  ...
  var handleRef = react_1.useCallback(
    function (node) {
  ...
  var renderPopover = function () {
    ...
    return react_1.default.createElement(
      PopoverPortal_1.PopoverPortal,
      { element: popoverRef.current, container: containerParent },
      typeof content === 'function' ? content(popoverState) : content,
    );
  };
  return react_1.default.createElement(react_1.default.Fragment, null, renderChild(), renderPopover());
});
