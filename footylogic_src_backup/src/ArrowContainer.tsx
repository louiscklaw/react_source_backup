...
exports.ArrowContainer = function (_a) {
  ...
  var mergedStyle = react_1.useMemo(
    function () {
      return __assign(__assign({}, containerStyle), arrowContainerStyle);
    },
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement('div', { style: arrowStyle }),
    children,
  );
};
